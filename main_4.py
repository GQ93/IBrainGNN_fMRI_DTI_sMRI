...
def main(args):
    ...
    mask_filename = r'F:\projects\AiyingT1MultimodalFusion\scripts\results\hcdp\cam\symmetric_mask_shafer.npy'
    ...
    np.save(r'F:\projects\AiyingT1MultimodalFusion\scripts\results\hcdp\cam\activations_shafer.npy', all_activations)
    np.save(r'F:\projects\AiyingT1MultimodalFusion\scripts\results\hcdp\cam\gradients_shafer.npy', all_gradients)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--alpha', type=float,  default=1e-2, help='L1 sparsity for mask')
